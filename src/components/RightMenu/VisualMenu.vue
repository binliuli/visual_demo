<template>
  <div class="visualmenu" v-if="menuOriginData.display">
    <rightmenucommon ref="menuchild" :menudata="menuDataResult" :menupos="menuPosResult" @closeMenu="closeMenu" @rightmenuclick="rightmenuclickhandler"></rightmenucommon>
  </div>
</template>
  ...
  methods: {
    ...
    initData() {
      ...
      if (
        ...
        this.menuOriginData.links.length == 1
      ) {
        //  this.menuDataResult = {
        //    displaydata: [
        //      {
        ...
        const showUnfoldRelationToNode =
          this.menuOriginData.links.length === 1 &&
          isFoldedRelation(this.menuOriginData.links[0]);
        showUnfoldRelationToNode &&
          this.menuDataResult.displaydata.push({
            id: "2",
            fill: "#6C62FA",
            title: "展开关系",
